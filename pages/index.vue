  ...
  <div>
    ...
    <div class="size-20">
      <common-image fit="cover"
        src="https://plus.unsplash.com/premium_photo-1712499322952-a0374a1d22c9?q=80&w=1996&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="image" />
    </div>
    <client-only>
